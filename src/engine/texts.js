...
export const RULE_META = {
  R1: { links: [{ label: 'Silbernagel 2007 (DOI)', url: 'https://doi.org/10.1177/0363546506298279' }],
    name: 'Schmerz-Ampel', lvl: 'rct', lvlLabel: 'RCT',
  ...
  R3: { links: [{ label: 'Steven Low', url: 'https://stevenlow.org/' }, { label: 'The Climbing Doctor', url: 'https://theclimbingdoctor.com/' }, { label: 'Hooper’s Beta', url: 'https://www.hoopersbeta.com/' }],
    name: 'Sehnen/Pulley-Erholung', lvl: 'expert', lvlLabel: 'Experten-Konsens',
  ...
  R4: { links: [{ label: 'Physiopedia · DOMS', url: 'https://www.physio-pedia.com/Delayed_Onset_Muscle_Soreness_(DOMS)' }],
    name: 'Exzentrische Erholung', lvl: 'cohort', lvlLabel: 'Kohorte',
  ...
  R6: { links: [{ label: 'Schumann 2022 (DOI)', url: 'https://doi.org/10.1007/s40279-021-01587-7' }],
    name: 'Kraft/Ausdauer-Interferenz', lvl: 'meta', lvlLabel: 'Meta-Analyse',
  ...
  R7: { links: [{ label: 'Gabbett 2016 (DOI)', url: 'https://doi.org/10.1136/bjsports-2015-095788' }],
    name: 'ACWR-Wochenlast', lvl: 'cohort', lvlLabel: 'Kohorte · umstritten',
